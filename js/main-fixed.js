...
function getActiveTabIndex(tabElements) {
  for (let i = 0; i < tabElements.length; i++) {
    const isActive = tabElements[i].classList.contains('tabs__item--active');
...
(function () {
  var switchTabs = function (block) {
    ...
    var activeTabIndex = getActiveTabIndex(tabElements);
